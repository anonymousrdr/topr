...
mkdir $HOME/aflgo-top/build; cd $HOME/aflgo-top/build
...
mv clang-11.0.0.src $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src/tools/clang
mv compiler-rt-11.0.0.src $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src/projects/compiler-rt
mv libcxx-11.0.0.src $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src/projects/libcxx
mv libcxxabi-11.0.0.src $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src/projects/libcxxabi

mkdir -p build-llvm/llvm; cd build-llvm/llvm
cmake -G "Ninja" \
      -DLIBCXX_ENABLE_SHARED=OFF -DLIBCXX_ENABLE_STATIC_ABI_LIBRARY=ON \
      -DCMAKE_BUILD_TYPE=Release -DLLVM_TARGETS_TO_BUILD="X86" \
      -DLLVM_BINUTILS_INCDIR=/usr/include $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src
ninja; sudo ninja install

cd $HOME/aflgo-top/build/llvm_tools
...
cmake -G "Ninja" \
      ...
      -DLIBCXX_ENABLE_SHARED=OFF -DLIBCXX_ENABLE_STATIC_ABI_LIBRARY=ON \
      -DCMAKE_BUILD_TYPE=Release -DLLVM_TARGETS_TO_BUILD="X86" \
       $HOME/aflgo-top/build/llvm_tools/llvm-11.0.0.src
